...
class BusinessUnitPolicy
{
    ...
    {
        return $user->can('view_any_business::unit');
    }
    ...
    {
        return $user->can('create_business::unit');
    }
    ...
    {
        return $user->can('delete_any_business::unit');
    }
    ...
    {
        return $user->can('force_delete_business::unit');
    }
    ...
    {
        return $user->can('force_delete_any_business::unit');
    }
    ...
    {
        return $user->can('restore_business::unit');
    }
    ...
    {
        return $user->can('restore_any_business::unit');
    }
    ...
    {
        return $user->can('replicate_business::unit');
    }
    ...
    {
        return $user->can('reorder_business::unit');
    }
}
